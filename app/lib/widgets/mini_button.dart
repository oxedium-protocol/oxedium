    ...
    return CustomInkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
            border: Border.all(color: isHover ? Colors.deepPurpleAccent : Colors.transparent),
            borderRadius: BorderRadius.circular(5.0),
            color: Colors.grey.shade900),
        child: Text(widget.text,
            style: TextStyle(fontSize: 14.0, color: isHover ? Colors.deepPurpleAccent : Colors.grey.shade700)),
      ),
    );
  }
}
